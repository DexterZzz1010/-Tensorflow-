...
model.compile(optimizer=keras.optimizers.Adam(lr=0.001),
              ...
              metrics=['acc'])
# 训练模型
model.fit(test_image_ds, steps_per_epoch=train_count // BATCH_SIZE, epochs=5, validation_data=test_image_ds,
...
model.fit(test_image_ds, steps_per_epoch=train_count // BATCH_SIZE, epochs=total_epoch,initial_epoch=initial_epoch, validation_data=test_image_ds,
                    validation_steps=test_count // BATCH_SIZE)
